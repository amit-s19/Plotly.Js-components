...
import { receivedCarddata as rcd } from '../compDummyData';
...
const ReceivedCardForm = () => {
  ...
  const [config, setConfig] = useState({
    dataset: rcd, cardWidth: 200, cardHeight: 180, cardBackground: '#428a75', cardFamily1: 'Arial',
    cardSize1: 20, cardWeight1: 'bold', cardColor1:'#fff', cardAlign1:'left', cardFamily2: 'Arial', 
    cardSize2: 30, cardWeight2: 'bold', cardColor2: '#fff',cardColor3: '#aacdbe', cardSize3: 14, 
...
export default ReceivedCardForm ;