...
import {lastCarddata as lcd} from '../compDummyData';
...
const LastCardForm = () => {
  ...
  const [config, setConfig] = useState({
    dataset: lcd, cardWidth: 315, cardHeight: 100, cardBackground: '#202A3B', cardFamily1: 'Arial',
    cardSize1: 18, cardWeight1: 'bold', cardColor1:'white', cardAlign1:'center', cardFamily2: 'Arial', 
    cardSize2: 12, cardWeight2: 'normal', cardColor2: '#bbceec', cardAlign2: 'center', 
